...
const DUMMY_DOCTORS = [
  {
    user: {
      username: 'dr.smith',
      password_hash: '$2a$10$HMmq6EwufazagEbs/.8tQ.mGFYln1tJ5kei5AFP7kM2dBLO/KjVRC', // You should use proper password hashing in production
      role: 'doctor',
  ...
  },
  {
    user: {
      username: 'dr.jones',
      password_hash: '$2a$10$HMmq6EwufazagEbs/.8tQ.mGFYln1tJ5kei5AFP7kM2dBLO/KjVRC',
      role: 'doctor',
    ...
    try {
      ...
      for (const data of DUMMY_DOCTORS) {
        ...
        const [userResult] = await connection.query(
          ...
          [data.user.username, data.user.password_hash, data.user.role, data.user.email]
        );
