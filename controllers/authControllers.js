...
exports.registerUser = async (req, res) => {
    const { first_name, last_name, email, address, phone, gender, password, user_type, date_of_birth } = req.body;
    ...
    try {
        ...
        const [user] = await db.execute('INSERT INTO users (email, username, role, password_hash) VALUES (?, ?, ?, ?)', [
            email,
            username,
        ...
        if (user_type === 'patient') {
            ...
            await db.execute('INSERT INTO patients (first_name, last_name, address, phone, gender, date_of_birth, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)', [
...
exports.getUser = async (req, res) => {
    try {
        const [userRows] = await db.execute('SELECT id, email, role FROM users WHERE id = ?', [req.user.id]);
...
exports.updateProfile = async (req, res) => {
    try {
        ...
        const { first_name, last_name, address, phone, gender, date_of_birth } = req.body;
